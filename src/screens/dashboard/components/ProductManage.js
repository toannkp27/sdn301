      ...
      <div className="m-3">
        ...
        >
          <Inputz
            ...
            onChange={(e) =>
              setFilter({ ...filter, key_search: e.target.value })
            }
          />
          <Dropdownz
            value={filter.status}
    ...
    return (
      <div className="card bg-color m-4 ">
        <div class="formgrid grid m-3">
          <div class="field col">
            <InputForm id="name" value={obj.name} label="Name" />
            <InputForm id="imgage" value={obj.image} label="Image " />
            <InputForm id="price " value={TimeBody(obj.price)} label="Price " />
            <InputForm id="Category" value={obj.category} label="Category" />
        ...
        <div className="m-3 mt-2 px-2 change-disabled">
          <div className="w-full flex justify-content-between">
            <label className="text-4xl w-full mb-2">Cart</label>
          </div>
          <div className="w-full border-round border-solid border-1 surface-border">
            ...
            >
              ...
              <Column
                field="unit_price"
                header="Unit Price"
                body={(rowData) => priceBodyTemplate(rowData.unit_price)}
              />
              <Column
                header="Total Cost"
                body={(rowData) =>
                  priceBodyTemplate(rowData.unit_price * rowData.quantity)
                }
              />
            </DataTable>
          </div>
